...
# Definir solo la ficha de Hidrología (Fuente Hidráulica ahora está en el tablero unificado)
...
def create_technology_card(tech):
    ...
    ], lg=6, md=6, sm=12, className="mb-4")  # Cambiado a lg=6 para centrar una sola ficha
