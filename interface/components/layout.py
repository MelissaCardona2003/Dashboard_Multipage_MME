...
def crear_navbar_horizontal():
    ...
    return dbc.NavbarSimple(
        children=[
            ...
            dbc.NavItem(dbc.NavLink("Costo Unitario", href="/costo-unitario", active="partial")),
            dbc.NavItem(dbc.NavLink("CU por Usuario", href="/costo-usuario-final", active="partial")),
            dbc.NavItem(dbc.NavLink("Pérdidas NT", href="/perdidas-nt", active="exact")),
